...
velest_sta_corr="../VELEST/QMigrate/velest.sta" #velest's output (mode=0 only), renamed.
velest_vel="../VELEST/QMigrate/velest.mod" #velest's output (mode=0), renamed.
...
cat ../../Pick/QMigrate/*.phase_sel.txt > $phasein
