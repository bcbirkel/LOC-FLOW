...
stationin="../../lower_model/model_files/lowered_0p75/lowered_station_full.dat"
...
for picker in "${pickers[@]}"; do
    ...
    echo "========================================================"
    velest_sta_corr=../VELEST/all_stations/PhaseNet/velest.sta #velest's output (mode=0 only), renamed.
    velest_vel=../VELEST/all_stations/PhaseNet/model2.nd
    # ../VELEST/$picker/velest.mod #velest's output (mode=0), renamed.
    ...
    python mk_vel_velest2hypoinverse_CRE.py $velest_vel
    ...
    cat ../../lower_model/model_files/lowered_0p75/*.phase_sel.txt > $phasein
    ...
    hyp1.40 <hyp_test_welev.command
