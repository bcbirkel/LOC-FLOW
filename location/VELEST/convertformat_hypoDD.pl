...
$zmin = -1.5; # was -0.2 # the smallest depth allowed (e.g., -0.2 -> above the sea level)
...
$v2=0.00;
open(OT,">$stause");
print OT "(a4,1x,f7.4,a1,1x,f8.4,a1,1x,i4,1x,i1,1x,i3,1x,f5.2,2x,f5.2)\n";
...
foreach $file(@par){
    ...
    if($test eq "#"){
		...
		my ($jk,$year,$month,$day,$hour,$min,$sec,$lat,$lon,$dep,$mag,$jk,$jk,$jk,$num) = @fields;
